...
namespace MOCA_Services.Services
{
    public class BabyTrackingService : IBabyTrackingService
    {
        ...
        public Task<IEnumerable<BabyTracking>> GetAlLBabyTrackingAsync()
        {
            return _repo.GetAlLBabyTrackingAsync();
        }

        public Task<BabyTracking> GetBabyTrackingByIdAsync(int id)
        {
