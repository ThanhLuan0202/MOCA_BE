...
namespace MOCA_Services.Services
{
    public class PregnancyTrackingService : IPregnancyTrackingService
    {
        ...
        public Task<IEnumerable<PregnancyTracking>> GetPregnancyTrackingByIdAsync(int id)
        {
            return _repo.GetPregnancyTrackingByIdAsync(id);
        }

        public Task<PregnancyTracking> GetPregnancyTrackingByUserId(int id)
        {
            return _repo.GetPregnancyTrackingByUserId(id);
        }
