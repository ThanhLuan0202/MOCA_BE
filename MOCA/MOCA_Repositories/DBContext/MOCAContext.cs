...
public partial class MOCAContext : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-E4KH349\\LUANNE;Initial Catalog=MOCA;Persist Security Info=True;User ID=sa;Password=12345");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdId).HasName("PK__Advertis__7130D5AE62AAF22A");
        ...
        {
            entity.HasKey(e => e.CheckupBabyId).HasName("PK__BabyTrac__D24787C68A333B52");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__BookingP__9B556A3813C6E44E");
        ...
        {
            entity.HasKey(e => e.BookmarkId).HasName("PK__Bookmark__541A3A911198F40C");
        ...
        {
            entity.HasKey(e => e.PostId).HasName("PK__Communit__AA126018E720D5B6");
        ...
        {
            entity.HasKey(e => e.ReplyId).HasName("PK__Communit__C25E4609EF2A9D22");
        ...
        {
            entity.HasKey(e => e.CourseId).HasName("PK__Courses__C92D71A75652E6E3");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__CourseCa__19093A2B63A28863");
        ...
        {
            entity.HasKey(e => e.DiscountId).HasName("PK__Discount__E43F6DF65F48C105");
        ...
        {
            entity.HasKey(e => e.BookingId).HasName("PK__DoctorBo__73951AED853F6024");
        ...
        {
            entity.HasKey(e => e.ContactId).HasName("PK__DoctorCo__5C66259B7C94B0BC");
        ...
        {
            entity.HasKey(e => e.DoctorId).HasName("PK__DoctorPr__2DC00EBF544FBAEB");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__6A4BEDF6AA495A4B");
        ...
        {
            entity.HasKey(e => e.LessonId).HasName("PK__Lessons__B084ACD04686859D");
        ...
        {
            entity.HasKey(e => e.MessageId).HasName("PK__Messages__C87C0C9CC4087D53");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__MomProfi__1788CCAC5C5D1197");
        ...
        {
            entity.HasKey(e => e.PackageId).HasName("PK__Packages__322035ECA9B61943");
        ...
        {
            entity.HasKey(e => e.LikeId).HasName("PK__PostLike__A2922C14A45F3614");
        ...
        {
            entity.HasKey(e => e.TrackingId).HasName("PK__Pregnanc__3C19EDD10D63A85E");
        ...
        {
            entity.HasKey(e => e.PurchasePackageId).HasName("PK__Purchase__C3B05BF074796988");
        ...
        {
            entity.HasKey(e => e.PurchasedId).HasName("PK__Purchase__2B7C245CF483F722");
        ...
        {
            entity.HasKey(e => e.RefLectId).HasName("PK__RefLect__42A5357DD3C3B807");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE3A604EAF89");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCACD023DAF0");
        ...
        {
            entity.HasKey(e => e.PregnancyId).HasName("PK__UserPreg__06D6610832C55802");
